...
class PermissionForm extends BaseAdminForm
{
    ...
    public function buildForm()
    {
        ...
        $this->add('permission_group', 'choice', [
            'label' => __('admin.permissions.placeholder-fields.permission_group'),
            'label_attr' => [
                'class' => 'control-label col-xs-12',
            ],
            'attr' => [
                'placeholder' => __('admin.permissions.placeholder-fields.form_permission_group'),
        ...
        $this->add('description', 'text', [
            'label' => __('admin.permissions.placeholder-fields.description'),
            'label_attr' => [
                'class' => 'control-label',
            ],
            'attr' => [
